...
[_RAISE] = LAYOUT_ortho_4x12( \
  _______,  KC_F1 ,  KC_F2 ,  KC_F3 ,  KC_F4 , S(KC_LBRC), S(KC_RBRC), S(KC_7), S(KC_8), ___x___, ___x___, ___x___, \
  _______,  KC_F5 ,  KC_F6 ,  KC_F7 ,  KC_F8 , S(KC_9)   ,    S(KC_0), S(KC_4), S(KC_5), S(KC_6), ___x___, _______, \
  _______,  KC_F9 ,  KC_F10,  KC_F11,  KC_F12, KC_LBRC   ,    KC_RBRC, S(KC_1), S(KC_2), S(KC_3), ___x___, _______, \
  _______, _______, _______, _______, _______, _______   ,    _______, _______, _______, _______, _______, _______  \
),
