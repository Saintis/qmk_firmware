...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     */
    [_QWERTY] = PREONIC(\
       KC_GRV, _________________NUMBER_L0_________________, _________________NUMBER_R0_________________, KC_DEL, \
      ...
      KC_LSFT, _________________QWERTY_L3_________________, _________________QWERTY_R3_________________, SFT_ENT, \
       KC_ESC, KC_BSLS, KC_LALT,  KC_LCMD,  LOWER,  KC_SPC, KC_BSPC,  RAISE,  KC_RCMD, KC_RALT, KC_RCTL, ___x___ \
    ),
    ...
    [_NORMAN] = PREONIC(\
       KC_GRV, _________________NUMBER_L0_________________, _________________NUMBER_R0_________________, KC_DEL, \
       KC_TAB, _________________NORMAN_L1_________________, _________________NORMAN_R1_________________, KC_MINS, \
      KC_LCTL, _________________NORMAN_L2_________________, _________________NORMAN_R2_________________, KC_QUOT, \
      KC_LSFT, _________________NORMAN_L3_________________, _________________NORMAN_R3_________________, SFT_ENT, \
       KC_ESC, KC_BSLS, KC_LALT,  KC_LCMD,  LOWER,  KC_SPC, KC_BSPC,  RAISE,  KC_RCMD, KC_RALT, KC_RCTL, ___x___ \
    ),
     ...
     */
    [_LOWER] = PREONIC( \
    S(KC_GRV), S(KC_1), S(KC_2), S(KC_3), S(KC_4), S(KC_5), S(KC_6), S(KC_7), S(KC_8), KC_BSLS, KC_LBRC, KC_RBRC, \
      _______,   SCSHT,   SCSLC,     W_L,     W_R, KC_LCBR, KC_RCBR, S(KC_7), S(KC_8),  KC_EQL, KC_LPRN, KC_RPRN, \
      _______,   DSK_L,   DSK_U,   DSK_D,   DSK_R, KC_LPRN, KC_RPRN, S(KC_4), S(KC_5), S(KC_6), KC_LCBR, KC_RCBR, \
     ...
     * │     │     │  ←  │  ↓  │  →  │  (  │  )  │  4  │  5  │  6  │  -  │  +  │
     * ├─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┤
     * │     │ Next│ Vol-│ Vol+│ Prev│  [  │  ]  │  1  │  2  │  3  │  -  │     │
     * ├─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┤
     * │     │     │     │     │     │     │     │     │  0  │  .  │  ,  │     │
     * └─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┘
     */
    [_RAISE] = PREONIC( \
       KC_GRV,    KC_1,   KC_2,     KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9, _______, _______, \
      _______, ___x___, KC_HOME,  KC_UP,   KC_END, KC_LCBR, KC_RCBR,   KC_P7,   KC_P8,   KC_P9, KC_PEQL, KC_UNDS, \
      _______, ___x___, KC_LEFT, KC_DOWN, KC_RGHT, KC_LPRN, KC_RPRN,   KC_P4,   KC_P5,   KC_P6, KC_PAST, KC_PPLS, \
      _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY, KC_LBRC, KC_RBRC,   KC_P1,   KC_P2,   KC_P3, KC_PMNS, _______, \
      _______, _______, _______, _______, _______, _______, _______, _______,   KC_P0,  TAP_DE, KC_COMM, _______  \
    ),
    ...
    [_ADJUST] = PREONIC( \
      ...
      BACKLIT, ___x___, ___x___, ___x___, ___x___, KC_LBRC, KC_RBRC, ___x___,  MU_MOD,   MU_ON,  MU_OFF, _______, \
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______  \
    )
